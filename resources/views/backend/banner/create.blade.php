                            ...
                            <form id="quickForm" action="{{ route('banner.store') }}" method="POST">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="bigTitle" class="form-control" id="exampleInputEmail1"
                    ...
                    {{ old('discreption') }}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="type"> Select banner or promo
                                            <option value="">---Select you option---</option>
                                            <option value="promo" {{ old('type') == 'promo' ? 'selected' : '' }}>---promo---
                                            </option>
                                            <option value="banner" {{ old('banner') == 'inactive' ? 'selected' : '' }}>
                                                ---banner--</option>
                                            <option value="header" {{ old('type') == 'header' ? 'selected' : '' }}>---header---
                                            </option>
