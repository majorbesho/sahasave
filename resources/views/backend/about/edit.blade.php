          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Update About  <small>Update About</small></h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <div class="col-12">
              ...
              <form id="quickForm" action="{{route('about.update',$about->id)}}" method="POST">
                @csrf
                @method('patch')
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                      ...
                      class="form-control" id="exampleInputEmail1"
                      placeholder="Enter youtubeUrl" value="{{$about->youtubeUrl}}">
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      class="form-control" id="exampleInputEmail1"
                      placeholder="Enter testim_caption" value="{{$about->testim_caption}}">
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      class="form-control" id="exampleInputEmail1"
                      placeholder="Enter team_caption" value="{{$about->team_caption}}">
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      class="form-control" id="exampleInputEmail1"
                      placeholder="Enter no1" value="{{$about->no1}}">
                    </div>
                    <div class="form-group">
                      <label for="text1">text1</label>
                      <input type="text" name="text1"
                      class="form-control" id="exampleInputEmail1"
                      placeholder="Enter text1" value="{{$about->text1}}">
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      class="form-control" id="exampleInputEmail1"
                      placeholder="Enter no2" value="{{$about->no2}}">
                    </div>
                    <div class="form-group">
                      <label for="text2">text2</label>
                      <input type="text2" name="text2"
                      class="form-control" id="exampleInputEmail1"
                      placeholder="Enter text2" value="{{$about->text2}}">
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      class="form-control" id="exampleInputEmail1"
                      placeholder="Enter no3" value="{{$about->no3}}">
                    </div>
                    <div class="form-group">
                      <label for="text3">text3</label>
                      <input type="text3" name="text3"
                      class="form-control" id="exampleInputEmail1"
                      placeholder="Enter text3" value="{{$about->text3}}">
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      class="form-control" id="exampleInputEmail1"
                      placeholder="Enter no4" value="{{$about->no4}}">
                    </div>
                    <div class="form-group">
                      <label for="text4">text4</label>
                      <input type="text" name="text4"
                      class="form-control" id="exampleInputEmail1"
                      placeholder="Enter text4" value="{{$about->text4}}">
                    </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      class="form-control" id="exampleInputEmail1"
                      placeholder="Enter city" value="{{$about->city}}">
                    </div>
