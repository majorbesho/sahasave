            ...
            <div class="col-12">
              ...
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Article with default features</h3>
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        checked data-onlabel="Ready"  value="{{$item->id}}"
                        {{$item->status=='active' ? 'checked': ''}}
                         data-offlabel="Not Ready" name="toogle"
                    ...
                    <td>
                        <a href="{{route('art.edit',$item->id)}}" data-toggle="tooltip"
                         title="edit"
                        ...
                        <form action="{{route('art.destroy',$item->id)}}" method="post">
                            @csrf
                            @method('delete')
