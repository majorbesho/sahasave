                ...
                <div class="col-lg-6 p-0 totalcart">
                    <div class="w-85">
                            ...
                            @foreach (\Gloudemans\Shoppingcart\Facades\Cart::instance('shopping')->content() as $item)
                                ...
                                justify-content: space-between;align-items: center;">
                                    ...
                                    <div class="itemImg">
                                        ...
                                        @endphp
                                        <img src="{{ $photos[0] }}" alt="image" width="150px" height="150px">
                                    </div>
                                    <div class="itemInfo">
                        ...
                        <div class="tamara">
                            ...
                            <form action="{{ route('tamara.post') }}" method="POST">
                                ...
                                <button type="submit">
                                    ...
                                    <tamara-widget type="tamara-card-snippet" lang="en" country="AE"></tamara-widget>
                                </button>
