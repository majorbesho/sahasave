                ...
                <div class="row">
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-info">
                            <div class="inner">
                                {{-- <h3>{{ \App\Models\LoadPackage::count() }}</h3> --}}
                    ...
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-success">
                            <div class="inner">
                                {{-- <h3>{{ \App\Models\trucks::count() }}<sup style="font-size: 20px"></sup></h3> --}}
                    ...
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-warning">
                            <div class="inner">
                                {{-- <h3> {{ \App\Models\Carrier::count() }} </h3> --}}
                    ...
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-warning">
                            <div class="inner">
                                {{-- <h3> {{ \App\Models\Shipper::count() }} </h3> --}}
