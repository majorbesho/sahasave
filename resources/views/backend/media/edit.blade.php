          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Update media  <small>Update media</small></h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <div class="col-12">
              ...
              <form id="quickForm" action="{{route('media.update',$media->id)}}" method="POST">
                @csrf
                @method('patch')
                <div class="card-body">
            ...
            ,
                ...
                'instabeUrl', --}}
                  ...
                  <div class="form-group">
                    ...
                    class="form-control" id="exampleInputEmail1"
                    placeholder="Enter youtubeUrl" value="{{$media->youtubeUrl}}">
                  </div>
                  <div class="form-group">
                    <label for="faceUrl">faceUrl</label>
                    <input type="text" name="faceUrl"
                    class="form-control" id="exampleInputEmail1"
                    placeholder="Enter faceUrl" value="{{$media->faceUrl}}">
                  </div>
                  <div class="form-group">
                    <label for="instabeUrl">instabeUrl</label>
                    <input type="text" name="instabeUrl"
                    class="form-control" id="exampleInputEmail1"
                    placeholder="Enter instabeUrl" value="{{$media->instabeUrl}}">
                  </div>
                  ...
                  <div id="holder" style="margin-top:15px;max-height:100px;" value="{{$media->photo}}"></div>
                   ...
                   <div class="form-group">
                    <select name="status"> Select your option
                        ...
                        <option value="inactive" {{$media->status=='inactive' ? 'selected':''  }}>---inactive--</option>
                    </select>
                  </div>
