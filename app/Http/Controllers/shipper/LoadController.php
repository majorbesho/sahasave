...
class LoadController extends Controller
{
    ...
    public function  trucksshow(Request $request)
    {
        ...
        return view('shipper.trucks.trucks', compact('trucks', 'brands'));
    }
    ...
    public function index()
    {
        ...
        $loads = LoadPackage::where('createdBy', auth()->guard('shipper')->id())
            ->orderBy('id', 'DESC')
            ->paginate(20);

        return view('shipper.loads.index', compact('loads'));
    }
    ...
    {
        //
        return view('shipper.loads.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        $data['createdBy'] = auth()->guard('shipper')->id();
        ...
        if ($status) {
            return redirect()->route('loads.index')->with('success', 'LoadPackage created successfully.');
        } else {
    ...
    public function show($id)
    {
        ...
        if ($LoadPackage) {
            ...
            return view('shipper.loads.edite', compact('LoadPackage'));
        } else {
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($status) {
            return redirect()->route('loads.index')->with('success', 'LoadPackage updated successfully.');
        } else {
            return back()->with('error', 'Something went wrong.');
        }
    }
    ...
    public function destroy($id)
    {
        ...
        if ($LoadPackage) {
            ...
            if ($status) {
                return redirect()->route('loads.index')->with('success', ' Record Deleted');
            }
        } else {
