                                        ...
                                        <form method="POST" action="{{ route('register.submit') }}" class="">
                                            ...
                                            <div class="row">
                                                <div class="">
                                                    ...
                                                    <div class="row mb-3  pt-10">
                                                        <input type="text" name="referral_code" id="referral_code"  value="{{ $referral }}"
                                                            placeholder="Enter Your referral code (Optional )"
                                                            style="pointer-events: none;" >
                                                    </div>

                                                    {{-- <div class="row mb-3  pt-10 d-none">
                                                        <input type="text" name="parent" id="parent"  value="{{ $referral }}"
                                                            placeholder="Enter Your referral code (Optional )"
                                                            style="pointer-events: none;" >
                                                    </div> --}}
                                                    ...
                                                    <div class="row mb-3  pt-10 d-none" >
                                                        <input type="date" name="dateOfbarth" id=""
                                                            placeholder="Enter Your DD/MM/YYYY" value="12/12/1983">
                                                    </div>
                                                    <div class="row mb-3 pt-10" >
                                                        <select class=" form-select" id="single-select-clear-field" data-placeholder="nationality" name="nationality">
                                                    ...
                                                    <div class="col d-flex justify-content-end">
                                                        <button type="submit"
                                                            class="btn btn-primary btn-block pt-3 socailbtn col-12">
                                                            Proceed
                                                        </button>
                                                    </div>
                                                    <div class="row mb-0">
