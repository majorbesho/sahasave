          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Update client  <small>Update client</small></h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <div class="col-12">
              ...
              <form id="quickForm" action="{{route('client.update',$client->id)}}" method="POST">
                @csrf
                @method('patch')
                <div class="card-body">
                  ...
                  <div id="holder" style="margin-top:15px;max-height:100px;" value="{{$client->photo}}"></div>
