              ...
              <form id="quickForm" action="{{route('category.update',$category->id)}}" method="POST">
                ...
                <div class="card-body">
                  <div class="form-group">
                   ...
                   <div class="form-group">
                    <label for="Caturl">Csategory URl For 6/6 </label>
                  ...
                  <div id="holder" style="margin-top:15px;max-height:100px;" value="{{$category->photo}}"></div>
                  ...
                  <div class="form-group">
                    ...
                    <input id="is_parent" type="checkbox" name="is_parent" id="" value="{{$category->is_parent}}" {{$category->is_parent== 1 ? 'checked': ''}}>
                  </div>
                   <div class="form-group {{$category->is_parent==1 ? 'd-none':''}}" id="parent_id_dev">
