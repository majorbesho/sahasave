          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Add art  <small>Add New art</small></h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <div class="col-12">
              ...
              <form id="quickForm" action="{{route('art.store')}}" method="POST">
                @csrf
                <div class="card-body">
                  ...
                  <div class="input-group">
                    ...
                    <input id="thumbnail" class="form-control" type="text" name="mainImg">
                  </div>
