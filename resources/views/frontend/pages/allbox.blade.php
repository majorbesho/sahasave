                                                ...
                                                <div class="ec-product-inner">
                                                    <div class="ec-pro-image-outer">
                                                        <div class="ec-pro-image">
                                                            <a href="product-left-sidebar.html" class="image">
                                                                <img class="main-image" src="{{ $photos[0] }}"
                                                                    alt="{{ $boxone->title }}" />
                                                                <img class="hover-image" src="{{ $photos[0] }}"
                                                                    alt="Product" />
                                                            </a>
                                                            <span class="percentage">{{ $boxone->discount }}</span>
                                                            <a href="{{ route('groupOfProduct', $boxone->slug) }}"
                                                                class="quickview" data-link-action="quickview"
                                                            ...
                                                            <div class="ec-pro-actions">
                                                                ...
                                                                <button title="Add To Cart" class="add-to-cart add_to_cart"
                                                                    data-quantity="1" data-product-id="{{ $boxone->id }}"
                                                                    id="add_to_cart{{ $boxone->id }}"><i
                                                    ...
                                                    <div class="ec-pro-content">
                                                        <h5 class="ec-pro-title"><a
                                                                href="{{ route('groupOfProduct', $boxone->slug) }}">{{ $boxone->title }}</a>
                                                        </h5>
                                                        ...
                                                        <div class="ec-pro-list-desc">{{ $boxone->discreption }}
                                                        </div>
                                                        <span class="ec-price">
                                                            ...
                                                            <div class="ec-pro-color">
                                                                ...
                                                                <ul class="ec-opt-swatch ec-change-img">
                                                                    <li class="active"><a href="#"
                                                                            ...
                                                                            data-src="{{ asset('frontend/4/assets/images/product-image/6_1.jpg') }}"
                                                                            data-src-hover="{{ asset('frontend/4/assets/images/product-image/6_1.jpg') }}"
                                                                            data-tooltip="Gray"><span
                                                                                style="background-color:#e8c2ff;"></span></a>
                                                                    </li>
                                                                    <li><a href="#" class="ec-opt-clr-img"
                                                                            data-src="{{ asset('frontend/4/assets/images/product-image/6_2.jpg') }}"
                                                                            data-src-hover="{{ asset('frontend/4/assets/images/product-image/6_2.jpg') }}"
                                                ...
                                                @foreach ($category as $key => $singlecategory)
                                                    <li>
                                                        <div class="ec-sidebar-block-item">
                                                            <input type="checkbox" unchecked /> <a
                                                                href="#">{{ $singlecategory->title }}</a><span
                                                                class="checked"></span>
                                                        </div>
                                                    </li>
                            ...
                            <div class="sidebar col-lg-3">
                                <div class="sidebar-widgets-wrap">
                                    ...
                                    <div class="rang">
                                        ...
                                        <input type="range" min="100" max="150000" value="150000"
                                            style="width: 200px">
                                    </div>
                                </div>
                            </div>
