...
<footer class="footer inner-footer">
    <div class="footer-top">
                    ...
                    <div class="footer-widget">
                        ...
                        <div class="subscribe-input">
                            <form action="#">
                                ...
                                <button type="submit"
                                    class="btn btn-md btn-primary-gradient inline-flex align-items-center">
        ...
        <div class="footer-bg">
            <img src="{{ asset('frontend/xx/assets/assets/img/bg/footer-bg-01.png') }}" alt="img"
                class="footer-bg-01" />
            <img src="{{ asset('frontend/xx/assets/assets/img/bg/footer-bg-02.png') }}" alt="img"
                class="footer-bg-02" />
            <img src="{{ asset('frontend/xx/assets/assets/img/bg/footer-bg-03.png') }}" alt="img"
                class="footer-bg-03" />
            <img src="{{ asset('frontend/xx/assets/assets/img/bg/footer-bg-04.png') }}" alt="img"
                class="footer-bg-04" />
            <img src="{{ asset('frontend/xx/assets/assets/img/bg/footer-bg-05.png') }}" alt="img"
                class="footer-bg-05" />
        </div>
    </div>
        ...
        <div class="container">
            ...
            <div class="copyright">
                <div class="copyright-text">
                    <p class="mb-0">
                        Copyright © 2025 Doccure. All Rights
                        Reserved
                    </p>
                </div>
                <!-- Copyright Menu -->
                ...
                <ul class="payment-method">
                    <li>
                        <a href="javascript:void(0);"><img
                                src="{{ asset('frontend/xx/assets/assets/img/icons/card-01.svg') }}"
                                alt="Img" /></a>
                    </li>
                    <li>
                        <a href="javascript:void(0);"><img
                                src="{{ asset('frontend/xx/assets/assets/img/icons/card-02.svg') }}"
                                alt="Img" /></a>
                    </li>
                    <li>
                        <a href="javascript:void(0);"><img
                                src="{{ asset('frontend/xx/assets/assets/img/icons/card-03.svg') }}"
                                alt="Img" /></a>
                    </li>
                    <li>
                        <a href="javascript:void(0);"><img
                                src="{{ asset('frontend/xx/assets/assets/img/icons/card-04.svg') }}"
                                alt="Img" /></a>
                    </li>
                    <li>
                        <a href="javascript:void(0);"><img
                                src="{{ asset('frontend/xx/assets/assets/img/icons/card-05.svg') }}"
                                alt="Img" /></a>
                    </li>
                    <li>
                        <a href="javascript:void(0);"><img
                                src="{{ asset('frontend/xx/assets/assets/img/icons/card-06.svg') }}"
                                alt="Img" /></a>
                    </li>
                </ul>
            </div>
...
<!-- Bootstrap Bundle JS -->
<script src="{{ asset('frontend/xx/assets/js/bootstrap.min.js') }}"></script>
