<div class="col-lg-4 col-xl-3 theiaStickySidebar">
    @php
        $name = explode(' ', auth('broker')->user()->name);
        $photo = explode(' ', auth('broker')->user()->photo);
    @endphp
    <!-- Profile Sidebar -->
        ...
        <div class="widget-profile pro-widget-content">
            <div class="profile-info-widget">
                <a href="profile-settings-1.html" class="booking-doc-img">
                    <img src="{{ asset('storage/' . auth('broker')->user()->photo) }}" alt="User Image">
                </a>
                <div class="profile-det-info">
                    <h3><a href="profile-settings-1.html">{{ ucfirst($name[0]) }}</a></h3>
                    <div class="carrier-details">
                        <h5 class="mb-0">broker ID : {{ auth('broker')->user()->id }}</h5>
                    </div>
                    <span>created at <i class="fa-solid fa-circle"></i> {{ auth('broker')->user()->created_at }}</span>
                </div>
            </div>
        </div>
        <div class="dashboard-widget">
            <nav class="dashboard-menu">
                <ul>
                    ...
                    <li>
                        <a href="{{ route('broker.shipment.schedule') }}">
                            <i class="isax isax-calendar-1"></i>
                            <span>Shipment Schedule</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('broker.saved.load') }}">
                            <i class="isax isax-star-1"></i>
                            <span>Saved Loads</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('broker-loads.index') }}">
                            <i class="isax isax-truck"></i>
                            <span>loads Management</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('broker.myloads') }}">
                            <i class="isax isax-truck"></i>
                            <span>My loads </span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('broker.shipment.history') }}">
                    ...
                    <li>
                        <a href="{{ route('broker.trucks.show') }}">
                            <i class="isax isax-note-21"></i>
                            <span>Trucks </span>
                        </a>
                    </li>
