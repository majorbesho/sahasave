        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 text-center">
                <div class="loginHeading">
                    <h2 class="mainHeader">Create your free Carrier account</h2>
                    <p>
                ...
                <div class="loginForm">
                    <form method="POST" action="{{ route('carrierregisterpost') }}" class="">
                        @csrf
                        ...
                        {{-- <input type="text" class="form-control  simpleInput" id="nationality" name="nationality"> --}}
