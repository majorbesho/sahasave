        ...
        <div class="row">
            <div class="text-center col-lg-6 col-md-6">
                <div class="loginHeading">
                    <h2 class="mainHeader">Create your free broker account</h2>
                    <p>
                ...
                <div class="loginForm">
                    <form method="POST" action="{{ route('brokerregisterpost') }}" class="">
                        @csrf
                        ...
                        <button class="mt-4 btn btn-primary w-100" type="submit">Sign up!</button>
                    </form>
