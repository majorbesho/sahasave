...
<div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div welcome to smart box div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>Ref_ level</h1>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">ref_leves</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="col-12">
              ...
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">ref_leves with default features</h3>
                ...
                <div class="card-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <td>
                        <a href="{{route('ref_level.edit',$item->id)}}" data-toggle="tooltip"
                         title="edit"
                        ...
                        <form action="{{route('ref_level.destroy',$item->id)}}" method="post">
                            @csrf
                            @method('delete')
