          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">refgategory</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <td>{{$item->ref_viset}} </td>
                        <td>{{$item->ref_buy}} </td>


                    <td>
                        <a href="{{route('ref_category.edit',$item->id)}}" data-toggle="tooltip"
                         title="edit"
                        ...
                        <form action="{{route('ref_category.destroy',$item->id)}}" method="post">
                            @csrf
                            @method('delete')
