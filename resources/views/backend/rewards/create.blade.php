                    ...
                    <div class="card">
                        <form action="{{ route('admin.rewards.store') }}" method="POST">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="type" id="type" class="form-control @error('type') is-invalid @enderror" required>
                                                ...
                                                <option value="bonus_points" {{ old('type') == 'bonus_points' ? 'selected' : '' }}>Bonus Points</option>
                                                <option value="free_consultation" {{ old('type') == 'free_consultation' ? 'selected' : '' }}>Free Consultation</option>
                                            </select>
                                            @error('type')
                                                <span class="invalid-feedback">{{ $message }}</span>
                                            @enderror
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" step="0.01" name="cashback_amount" id="cashback_amount" class="form-control @error('cashback_amount') is-invalid @enderror" value="{{ old('cashback_amount') }}">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" step="0.01" name="discount_value" id="discount_value" class="form-control @error('discount_value') is-invalid @enderror" value="{{ old('discount_value') }}">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" step="0.01" name="max_discount_amount" id="max_discount_amount" class="form-control @error('max_discount_amount') is-invalid @enderror" value="{{ old('max_discount_amount') }}">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="bonus_points" id="bonus_points" class="form-control @error('bonus_points') is-invalid @enderror" value="{{ old('bonus_points') }}">
                                                @error('bonus_points')
                                                    <span class="invalid-feedback">{{ $message }}</span>
                                                @enderror
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" step="0.01" name="min_consultation_value" id="min_consultation_value" class="form-control @error('min_consultation_value') is-invalid @enderror" value="{{ old('min_consultation_value') }}">
                            ...
                            <div class="card-footer">
                                <button type="submit" class="btn btn-primary">Issue Reward</button>
