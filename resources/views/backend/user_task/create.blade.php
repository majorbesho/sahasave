          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Add user_task  <small>Add New user_task</small></h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <div class="col-12">
              ...
              <form id="quickForm" action="{{route('user_task.store')}}" method="POST">
                @csrf
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    class="form-control" id="exampleInputEmail1"
                    placeholder="Enter task_id" value="{{old('task_id')}}">
                  </div>
                  <div class="form-group">
                    <label for="reward_points">reward_points</label>
                    <input type="text" name="reward_points"
                    class="form-control" id="exampleInputEmail1"
                    placeholder="Enter reward_points" value="{{old('reward_points')}}">
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    class="form-control" id="exampleInputEmail1"
                    placeholder="Enter proof" value="{{old('proof')}}">
                  </div>
