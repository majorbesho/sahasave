    ...
    <div class="container">
        <nav class="navbar navbar-expand-lg header-nav">
            <div class="navbar-header">
                ...
                <a href="{{ route('shipper') }}" class="navbar-brand logo">
            ...
            <div class="header-menu">
                <div class="main-menu-wrapper">
                    <div class="menu-header">
                        <a href="{{ route('shipper') }}" class="menu-logo">
                    ...
                    <ul class="main-nav">
                        ...
                        <li class="has-submenu">
                            <a href="#">Shipper <i class="fas fa-chevron-down"></i></a>
                ...
                <ul class="nav header-navbar-rht">
                    ...
                    <li class="nav-item dropdown has-arrow logged-item">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            ...
                            <a class="dropdown-item" href="{{ route('shipper') }}">Dashboard</a>
                            <a class="dropdown-item" href="{{ route('shipper.setting') }}">Profile Settings</a>
                            <a class="dropdown-item" href="{{ route('shipper.logout') }}">Logout</a>
                        </div>
                    </li>
                    <!-- /User Menu -->
                </ul>
...
<ul class="navbar-nav">
    ...
    <li class="nav-item d-none d-sm-inline-block">
        <a class="nav-link" href="{{ route('shipper.logout') }}"
