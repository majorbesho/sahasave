                ...
                <div class="row">
                    ...
                    <div class="col-xl-6">
                        <div class="contact-page__top-form">
                            <form class="contact-form-validated why-choose-one__form" action="{{ route('contact.submit') }}"
                                method="POST">
                                @csrf
                                <div class="row">
                                    ...
                                    <div class="col-xl-12">
                                        <div class="input-box">
                                            <textarea name="message" placeholder="Message" required style="background: #e8f0fe;"></textarea>
