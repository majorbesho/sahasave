          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Add focus  <small>Add New focus</small></h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <div class="col-12">
              ...
              <form id="quickForm" action="{{route('focus.store')}}" method="POST">
                @csrf
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label for="mainWord">mainWord</label>
                    <input type="text" name="mainWord"
                    class="form-control" id="exampleInputEmail1"
                    placeholder="Enter title" value="{{old('mainWord')}}">
                  </div>
                  <div class="form-group">
