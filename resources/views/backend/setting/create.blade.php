          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Add setting  <small>Add New setting</small></h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <div class="col-12">
              ...
              <form id="quickForm" action="{{route('setting.store')}}" method="POST">
                @csrf
                <div class="card-body">
                  <div class="form-group">
                    ...
                    placeholder="Enter facebookUrl" value="{{old('facebookUrl')}}">
                  </div>
                  <div class="form-group">
                    <label for="twiettr">twiettr</label>
                    <input type="url" name="twiettr"
                    class="form-control" id="exampleInputEmail1"
                    placeholder="Enter twiettr" value="{{old('twiettr')}}">
                  </div>
                  <div class="form-group">
                    ...
                    class="form-control" id="exampleInputEmail1"
                    placeholder="Enter insta" value="{{old('insta')}}">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    class="form-control" id="exampleInputEmail1"
                    placeholder="Enter google" value="{{old('google')}}">
                  </div>
                  <div class="form-group">
