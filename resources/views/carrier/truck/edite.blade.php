...
@section('content')
    <div class="container">
        ...
        <form action="{{ route('loads.update', $truck->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" class="form-control" id="photo" name="photo">
                        @if ($load->photo)
                            <img src="{{ asset('storage/' . $load->photo) }}" alt="Current Photo" class="img-thumbnail mt-2"
                                width="100">
                        @endif
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="status" name="status">
                            <option value="active" {{ $LoadPackage->status == 'active' ? 'selected' : '' }}>Active</option>
                ...
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="paymentType" name="paymentType">
                            <option value="cod" {{ $LoadPackage->paymentType == 'cod' ? 'selected' : '' }}>COD</option>
                            <option value="prepaid" {{ $LoadPackage->paymentType == 'prepaid' ? 'selected' : '' }}>Prepaid
                            </option>
                            <option value="prepaid_cod"
                                {{ $LoadPackage->paymentType == 'prepaid_cod' ? 'selected' : '' }}>
                                Prepaid + COD</option>
                            <option value="prepaid_prepaid"
                                {{ $LoadPackage->paymentType == 'prepaid_prepaid' ? 'selected' : '' }}>Prepaid + Prepaid
                            </option>
                        </select>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="paymentStatus" name="paymentStatus">
                            ...
                            <option value="failed" {{ $LoadPackage->paymentStatus == 'failed' ? 'selected' : '' }}>Failed
                            </option>
                        </select>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="paymentMethod" name="paymentMethod">
                            ...
                            <option value="cheque" {{ $LoadPackage->paymentMethod == 'cheque' ? 'selected' : '' }}>Cheque
                            </option>
                            <option value="online" {{ $LoadPackage->paymentMethod == 'online' ? 'selected' : '' }}>Online
                            </option>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="trackingStatus" name="trackingStatus">
                            ...
                            <option value="delivered" {{ $LoadPackage->trackingStatus == 'delivered' ? 'selected' : '' }}>
                                Delivered</option>
                            <option value="delayed" {{ $LoadPackage->trackingStatus == 'delayed' ? 'selected' : '' }}>
                                Delayed
                            </option>
                            <option value="cancelled" {{ $LoadPackage->trackingStatus == 'cancelled' ? 'selected' : '' }}>
                                Cancelled</option>
                            <option value="failed" {{ $LoadPackage->trackingStatus == 'failed' ? 'selected' : '' }}>Failed
                            </option>
                        </select>
                    </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="loadType" name="loadType">
                            <option value="full" {{ $LoadPackage->loadType == 'full' ? 'selected' : '' }}>Full</option>
                            <option value="partial" {{ $LoadPackage->loadType == 'partial' ? 'selected' : '' }}>Partial
                            </option>
                        </select>
                    </div>
