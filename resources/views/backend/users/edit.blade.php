              ...
              <form id="quickForm" action="{{route('user.update',$user->id)}}" method="POST">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="password" name="password"
                    class="form-control" id="exampleInputEmail1"
                    placeholder="Enter password agin" value="{{$user->password}}">
                  </div>
                  ...
                  <img src=" {{$user->photo}}" id="holder" style="margin-top:15px;max-height:100px;"></img>
                  ...
                  <div class="form-group">
                    <select name="role"> Select your Role
                        <option value="" >---Select you option---</option>
