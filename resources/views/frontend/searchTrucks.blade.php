...
@section('content')
    <div class="container-fluid" style="padding-top: 108px;">
        <div class="row"
            style="align-items: center; align-content: space-between; flex-direction: row;     background: rgb(96 92 92 / 20%);">
            <form action="{{ route('search.Loads.Result') }}" method="post" class="searchForm"
                style="background: rgba(255, 255, 255, 0.2); border-radius: 10px; backdrop-filter: blur(10px); box-shadow: 0 4px 30px rgba(0, 0, 0, 0.1); width: 100%; padding: 15px;z-index:100;">
                @csrf
    ...
    <!-- Page Header Start -->
    <div class=" bg-section parallaxie">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                                ...
                                <div class="filter-group">
                                    ...
                                    <div class="price-slider">
                                        ...
                                        <div class="price-values">
                                            <span id="minValue">$50</span> - <span id="maxValue">$1000</span>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="card h-100 shadow-sm border-0">
                                            ...
                                            <div class="image-box">
                                                @if ($truck->photos && count($truck->photos) > 0)
                                                    <img src="{{ $truck->photos[0]->photo_path }}" class="card-img-top"
                                                        style="height: 200px; object-fit: cover;"
                                                        alt="{{ $truck->title }}">
                                                    <div class="image-overlay"></div>
                                                @else
                                                    <img src="{{ $truck->photo ?? asset('path/to/default/truck/image.jpg') }}"
                                            ...
                                            <div class="card-body"
                                                ...
                                                <!-- Truck Details -->
                                                <div class="truck-details text-white">
                                                    <ul class="list-unstyled mb-3">
                                                        <li class="mb-2 d-flex align-items-center">
                                                            <i class="fas fa-weight-hanging me-2"></i>
                                                            <span>{{ $truck->weight }} kg</span>
                                                        </li>
                                                        <li class="mb-2 d-flex align-items-center">
                                                            <i class="fas fa-ruler-horizontal me-2"></i>
                                                            <span>Length: {{ $truck->length }} m</span>
                                                        </li>
                                                        <li class="mb-2 d-flex align-items-center">
                                                            <i class="fas fa-ruler-vertical me-2"></i>
                                                            <span>Width: {{ $truck->width }} m</span>
                                                        </li>
                                                        <li class="mb-2 d-flex align-items-center">
                                                        ...
                                                        <li class="mb-2 d-flex align-items-center">
                                                            ...
                                                            <span>{{ $truck->location_city }},
                                                                {{ $truck->location_country }}</span>
                                                        </li>
                                                        @if ($truck->specification)
                                                            <li class="d-flex align-items-center">
                                                                <i class="fas fa-gas-pump me-2"></i>
                                                                <span>{{ $truck->specification->fuel_type }}</span>
                                                            </li>
                                                        @endif
                                                    </ul>
                                                </div>
                                                ...
                                                <div
                                                    ...
                                                    <a href="{{ route('indextrucks.show', $truck->slug) }}"
                                                        class="btn btn-sm btn-outline-light d-flex align-items-center justify-content-center"
                                                        style="min-width: 40px; min-height: 40px; z-index: 10; position: relative;">
                                                        <img src="{{ asset('/car/images/arrow-white.svg') }}"
                                                            alt="View Details" style="height: 20px;">
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
