                ...
                <div class="inner-right-login">
                    <div class="login-header">
                        ...
                        <form id="personal_details" enctype="multipart/form-data">
                            ...
                            <div class="mt-4 step-process-col">
                                <div class="mb-3" id="preg_div" style="display: none;">
                                    <label class="mb-2">Pregnancy Term</label>
                                    <select class="form-select form-control select" id="preg_term" name="preg_term"
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-5 ps-2">
                                            <select class="form-select form-control select" id="weight_unit"
                                                name="weight_unit">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-5 ps-2">
                                            <select class="form-select form-control select" id="height_unit"
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select form-control select" id="blood_group" name="blood_group"
                                        tabindex="-1" aria-hidden="true">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select form-control select" id="bp" name="bp"
                                        tabindex="-1" aria-hidden="true">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select form-control select" id="glucose" name="glucose"
                                        tabindex="-1" aria-hidden="true">
                                ...
                                <div class="checklist-col pregnant-col">
                                    <div class="remember-me-col d-flex justify-content-between">
                                        ...
                                        <label class="mb-3 custom_check">
                                            <input type="checkbox" class="" name="cancer" id="cancer"
                                                value="1">
                                            <span class="checkmark"></span>
                                        </label>
                                    </div>
                                    ...
                                    <div class="remember-me-col d-flex justify-content-between">
                                        ...
                                        <label class="mb-3 custom_check">
                                            <input type="checkbox" class="" name="medicine" id="medicine"
                                                value="1">
                                            <span class="checkmark"></span>
                                        </label>
                                    </div>
                                    <div class="remember-me-col" id="medicine_div" style="display:none">
                                        <div class="medicine_input">
                                            <input type="text" id="medicine_name" name="medicine_name[]"
                                                value="" class="form-control" placeholder="Enter medicine_name">
